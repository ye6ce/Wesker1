        ...
        <AnimatePresence mode="wait">
          {step === "lang" && (
            ...
            >
              ...
              <h2 className="font-heading text-2xl text-brand-green mb-8">{translations.selectLang[lang]}</h2>
          ...
          {step === "questions" && (
            ...
            >
              ...
              <h2 className="font-heading text-3xl md:text-5xl text-white mb-8 min-h-[80px] tracking-tight">
          ...
          {step === "done" && (
            ...
            >
              ...
              <h2 className="font-heading text-3xl text-brand-green mb-8">{translations.done[lang]}</h2>
